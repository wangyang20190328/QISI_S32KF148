...
#define SPI_IPW_SW_MAJOR_VERSION_PBCFG_C                 1
...
/* External device Configuration of SpiExternalDevice_MCU_SBC*/
static const Spi_ExternalDeviceConfigType Spi_ExternalDeviceConfig_SpiExternalDevice_MCU_SBC =
{
        /* SpiExternalDevice_MCU_SBC*/
        SPI_OVER_LPSPI, /* IpType */
        1U,  /* Instance */
        
        {   /* ExternalDeviceConfig */
            &Lpspi_Ip_DeviceAttributes_SpiExternalDevice_MCU_SBC /* LPSPI ExternalDeviceConfig */
...
/* External device Configuration of SpiExternalDevice_MCU_SOC*/
static const Spi_ExternalDeviceConfigType Spi_ExternalDeviceConfig_SpiExternalDevice_MCU_SOC =
{
        /* SpiExternalDevice_MCU_SOC*/
        SPI_OVER_LPSPI, /* IpType */
        2U,  /* Instance */
        
        {   /* ExternalDeviceConfig */
            &Lpspi_Ip_DeviceAttributes_SpiExternalDevice_MCU_SOC /* LPSPI ExternalDeviceConfig */
#if (SPI_IPW_SPI_FLEXIO_ENABLE == STD_ON)
            ,NULL_PTR /* Don't have FLEXIO_SPI ExternalDeviceConfig */
#endif
        },
...
const Spi_ExDevicesConfigType Spi_aExternalDeviceConfigList[2U] =
{
    {
    /* SpiExternalDevice_MCU_SBC */
    &Spi_ExternalDeviceConfig_SpiExternalDevice_MCU_SBC
    },
    {
    /* SpiExternalDevice_MCU_SOC */
    &Spi_ExternalDeviceConfig_SpiExternalDevice_MCU_SOC
    }
};
...
static const Spi_HWUnitConfigType Spi_HwUnitConfig_SpiPhyUnit_1 =
{
        ...
        SPI_SPURIOUS_CORE_ID_U32, /* SpiCoreUse */
        {
            &Lpspi_Ip_PhyUnitConfig_SpiPhyUnit_1 /* LPSPI IpConfig */
#if (SPI_IPW_SPI_FLEXIO_ENABLE == STD_ON)
            ,NULL_PTR /* Don't have Ipconfig of FLEXIO_SPI */
#endif
            #if ((LPSPI_IP_DMA_USED == STD_ON) && (LPSPI_IP_ENABLE_DMAFASTTRANSFER_SUPPORT == STD_ON))
