...
static Spi_BufferDescriptorType Spi_BufferSpiChannel_MCU_SBC;
/* Allocate Buffers for IB Channels (if any) */
static Spi_BufferDescriptorType Spi_BufferSpiChannel_MCU_SOC;
/* Allocate Buffers for IB Channels (if any) */
...
/* Channel Configuration of SpiChannel_MCU_SBC*/
static const Spi_ChannelConfigType Spi_ChannelConfig_SpiChannel_MCU_SBC =
{
        /* SpiChannel_MCU_SBC*/
  ...
  #endif
#endif
        (uint32)255U, /* u32DefaultTransmitValue (configured) */
        2U, /* Length (configured in SpiEbMaxLength) */
        &Spi_BufferSpiChannel_MCU_SBC, /* pcBufferDescriptor */
        SPI_SPURIOUS_CORE_ID_U32,
        &Spi_axSpiChannelState[0U] /* pChannelState pointer */
};
/* Channel Configuration of SpiChannel_MCU_SOC*/
static const Spi_ChannelConfigType Spi_ChannelConfig_SpiChannel_MCU_SOC =
{
        /* SpiChannel_MCU_SOC*/
        EB, /* BufferType IB or EB */
        8U, /* Frame size */
        ...
        2U, /* Length (configured in SpiEbMaxLength) */
        &Spi_BufferSpiChannel_MCU_SOC, /* pcBufferDescriptor */
        SPI_SPURIOUS_CORE_ID_U32,
...
static const Spi_ChannelsCfgType Spi_aChannelConfigList[2] =
{
    ...
    /* SpiChannel_MCU_SBC */
    /* SpiChannel_MCU_SBC */
    &Spi_ChannelConfig_SpiChannel_MCU_SBC
    },
    {
    /* SpiChannel_MCU_SOC */
    /* SpiChannel_MCU_SOC */
    &Spi_ChannelConfig_SpiChannel_MCU_SOC
    }
...
static const Spi_ChannelType Spi_SpiJob_0_ChannelAssignment[1] = {SpiConf_SpiChannel_SpiChannel_MCU_SBC};
static const Spi_ChannelType Spi_SpiJob_1_ChannelAssignment[1] = {SpiConf_SpiChannel_SpiChannel_MCU_SOC};
...
static const Spi_JobConfigType Spi_JobConfig_SpiJob_0 =
{
        ...
        SPI_SpiExternalDevice_MCU_SBC, /* External Device */
                &Spi_aExternalDeviceConfigList[SPI_SpiExternalDevice_MCU_SBC] /* pcExternalDeviceConfig - pointer to the external device configuration */        };
...
static const Spi_JobConfigType Spi_JobConfig_SpiJob_1 =
{
        ...
        CSIB1, /* HWUnit index */
        /* External Device Settings */
        SPI_SpiExternalDevice_MCU_SOC, /* External Device */
                &Spi_aExternalDeviceConfigList[SPI_SpiExternalDevice_MCU_SOC] /* pcExternalDeviceConfig - pointer to the external device configuration */        };
...
static const Spi_JobType Spi_SpiSequence_MCU_SBC_JobAssignment[1] = {SpiConf_SpiJob_SpiJob_0};
static const Spi_JobType Spi_SpiSequence_MCU_SOC_JobAssignment[1] = {SpiConf_SpiJob_SpiJob_1};
/* Configuration of Sequences */

/* Sequence Configuration of SpiSequence_MCU_SBC */
static const Spi_SequenceConfigType Spi_SequenceConfig_SpiSequence_MCU_SBC =
{
        /* SpiSequence_MCU_SBC */
        (Spi_JobType)1U,
        SPI_SPURIOUS_CORE_ID_U32,
        Spi_SpiSequence_MCU_SBC_JobAssignment, /* List of Jobs */
        NULL_PTR, /* End Notification */
        (uint8)TRUE /* Interruptible */
                #if ((SPI_DMA_USED == STD_ON) && (SPI_ENABLE_DMAFASTTRANSFER_SUPPORT == STD_ON))
        , (boolean)FALSE /* Enable Dma fast transfer */
        #endif
        
};
/* Sequence Configuration of SpiSequence_MCU_SOC */
static const Spi_SequenceConfigType Spi_SequenceConfig_SpiSequence_MCU_SOC =
{
        /* SpiSequence_MCU_SOC */
        (Spi_JobType)1U,
        SPI_SPURIOUS_CORE_ID_U32,
        Spi_SpiSequence_MCU_SOC_JobAssignment, /* List of Jobs */
        NULL_PTR, /* End Notification */
        (uint8)TRUE /* Interruptible */
                #if ((SPI_DMA_USED == STD_ON) && (SPI_ENABLE_DMAFASTTRANSFER_SUPPORT == STD_ON))
        , (boolean)FALSE /* Enable Dma fast transfer */
...
static const Spi_SeqsConfigType Spi_aSequenceConfigList[2] =
{
    ...
    /* SpiSequence_MCU_SBC */
    /* SpiSequence_MCU_SBC */
    &Spi_SequenceConfig_SpiSequence_MCU_SBC
    },
    {
    /* SpiSequence_MCU_SOC */
    /* SpiSequence_MCU_SOC */
    &Spi_SequenceConfig_SpiSequence_MCU_SOC
    }
};
