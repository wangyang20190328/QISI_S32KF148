...
#define I2C_IPW_PBCFG_SW_MAJOR_VERSION_C              1
#define I2C_IPW_PBCFG_SW_MINOR_VERSION_C              0
#define I2C_IPW_PBCFG_SW_PATCH_VERSION_C              1
...
#if (I2C_IPW_PBCFG_VENDOR_ID_C != LPI2C_IP_PBCFG_VENDOR_ID)
    #error "I2c_Ipw_PBCfg.c and Lpi2c_Ip_PBcfg.h have different vendor ids"
#endif

/* Check if current file and Lpi2c_Ip_PBcfg header file are of the same vendor */
#if (I2C_IPW_PBCFG_MODULE_ID_C   != LPI2C_IP_PBCFG_MODULE_ID)
    #error "I2c_Ipw_PBCfg.c and Lpi2c_Ip_PBcfg.h have different module ids"
#endif
/* Check if current file and Lpi2c_Ip_PBcfg header file are of the same Autosar version */
#if ((I2C_IPW_PBCFG_AR_RELEASE_MAJOR_VERSION_C != LPI2C_IP_PBCFG_AR_RELEASE_MAJOR_VERSION) || \
     (I2C_IPW_PBCFG_AR_RELEASE_MINOR_VERSION_C != LPI2C_IP_PBCFG_AR_RELEASE_MINOR_VERSION) || \
     (I2C_IPW_PBCFG_AR_RELEASE_REVISION_VERSION_C != LPI2C_IP_PBCFG_AR_RELEASE_REVISION_VERSION) \
    )
    #error "AutoSar Version Numbers of I2c_Ipw_PBCfg.c and Lpi2c_Ip_PBcfg.h are different"
#endif
/* Check if current file and Lpi2c_Ip_PBcfg header file are of the same Software version */
#if ((I2C_IPW_PBCFG_SW_MAJOR_VERSION_C  != LPI2C_IP_PBCFG_SW_MAJOR_VERSION) || \
     (I2C_IPW_PBCFG_SW_MINOR_VERSION_C  != LPI2C_IP_PBCFG_SW_MINOR_VERSION) || \
     (I2C_IPW_PBCFG_SW_PATCH_VERSION_C  != LPI2C_IP_PBCFG_SW_PATCH_VERSION) \
    )
    #error "Software Version Numbers of I2c_Ipw_PBCfg.c and Lpi2c_Ip_PBcfg.h are different"
#endif
