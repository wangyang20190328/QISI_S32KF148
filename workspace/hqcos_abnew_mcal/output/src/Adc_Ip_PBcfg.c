...
#define ADC_IP_AR_RELEASE_MINOR_VERSION_PBCFG_C      4
#define ADC_IP_AR_RELEASE_REVISION_VERSION_PBCFG_C   0
#define ADC_IP_SW_MAJOR_VERSION_PBCFG_C              1
#define ADC_IP_SW_MINOR_VERSION_PBCFG_C              0
#define ADC_IP_SW_PATCH_VERSION_PBCFG_C              1
...
static const Adc_Ip_ChanConfigType AdcIpChansConfig_0[4U] =
{
    ...
    {
        2U, /* ChnIdx */
        ADC_IP_INPUTCHAN_EXT17, /* Channel */
    #if (ADC_IP_AIEN_INTERRUPT_ENABLE == STD_ON)
        (boolean)FALSE /* InterruptEnable */
    #endif /* (ADC_IP_AIEN_INTERRUPT_ENABLE == STD_ON) */
    },
    {
        3U, /* ChnIdx */
        ADC_IP_INPUTCHAN_EXT18, /* Channel */
    #if (ADC_IP_AIEN_INTERRUPT_ENABLE == STD_ON)
        (boolean)FALSE /* InterruptEnable */
    #endif /* (ADC_IP_AIEN_INTERRUPT_ENABLE == STD_ON) */
    }
...
*/
static const Adc_Ip_ChanConfigType AdcIpChansConfig_1[3U] =
{
    {
        0U, /* ChnIdx */
        ADC_IP_INPUTCHAN_EXT18, /* Channel */
    ...
    {
        1U, /* ChnIdx */
        ADC_IP_INPUTCHAN_EXT19, /* Channel */
    #if (ADC_IP_AIEN_INTERRUPT_ENABLE == STD_ON)
        (boolean)FALSE /* InterruptEnable */
    #endif /* (ADC_IP_AIEN_INTERRUPT_ENABLE == STD_ON) */
    },
    {
        2U, /* ChnIdx */
        ADC_IP_INPUTCHAN_EXT20, /* Channel */
    #if (ADC_IP_AIEN_INTERRUPT_ENABLE == STD_ON)
        (boolean)FALSE /* InterruptEnable */
    #endif /* (ADC_IP_AIEN_INTERRUPT_ENABLE == STD_ON) */
    }
