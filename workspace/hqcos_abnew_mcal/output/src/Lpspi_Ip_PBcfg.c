...
#define LPSPI_IP_SW_MAJOR_VERSION_PBCFG_C                 1
...
#include "Spi_MemMap.h"
/* Lpspi_Ip_DeviceAttributes_SpiExternalDevice_MCU_SBC Device Attribute Configuration of Spi*/
const Lpspi_Ip_ExternalDeviceType Lpspi_Ip_DeviceAttributes_SpiExternalDevice_MCU_SBC =
{
    1U,  /* Instance */
        (uint32)(LPSPI_CCR_SCKPCS(19U) | LPSPI_CCR_PCSSCK(19U) | LPSPI_CCR_SCKDIV(198U) | LPSPI_CCR_DBT(127U)), /* CCR */
                (uint32)LPSPI_TCR_WIDTH(0U) | (LPSPI_TCR_CPOL(0U) | LPSPI_TCR_CPHA(1U) | LPSPI_TCR_PRESCALE(1U) |         LPSPI_TCR_PCS(0U) | LPSPI_TCR_CONT(0U)) /* TCR */
...
/* Lpspi_Ip_DeviceAttributes_SpiExternalDevice_MCU_SOC Device Attribute Configuration of Spi*/
const Lpspi_Ip_ExternalDeviceType Lpspi_Ip_DeviceAttributes_SpiExternalDevice_MCU_SOC =
{
    2U,  /* Instance */
        (uint32)(LPSPI_CCR_SCKPCS(19U) | LPSPI_CCR_PCSSCK(19U) | LPSPI_CCR_SCKDIV(198U) | LPSPI_CCR_DBT(127U)), /* CCR */
                (uint32)LPSPI_TCR_WIDTH(0U) | (LPSPI_TCR_CPOL(1U) | LPSPI_TCR_CPHA(1U) | LPSPI_TCR_PRESCALE(1U) |         LPSPI_TCR_PCS(0U) | LPSPI_TCR_CONT(0U)) /* TCR */
...
const Lpspi_Ip_ConfigType Lpspi_Ip_PhyUnitConfig_SpiPhyUnit_0 =
{
    ...
    (uint32)0,
    /* CFGR1 */
    (uint32)(LPSPI_CFGR1_PINCFG(0U) | LPSPI_CFGR1_PCSPOL(8U) | LPSPI_CFGR1_MASTER(1U) | LPSPI_CFGR1_SAMPLE(0U)),
...
/* The SPI Hw Unit configuration structures */
const Lpspi_Ip_ConfigType Lpspi_Ip_PhyUnitConfig_SpiPhyUnit_1 =
{
    2U,  /* Instance */
    /* CR */
    (uint32)0,
    /* CFGR1 */
    (uint32)(LPSPI_CFGR1_PINCFG(0U) | LPSPI_CFGR1_PCSPOL(4U) | LPSPI_CFGR1_MASTER(0U) | LPSPI_CFGR1_SAMPLE(0U)),
    #if (LPSPI_IP_SLAVE_SUPPORT == STD_ON)
    (boolean)TRUE,
    #endif
    #if (LPSPI_IP_DMA_USED == STD_ON)
