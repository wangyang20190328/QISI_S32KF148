...
#define WDG_43_INSTANCE0_IPW_AR_RELEASE_MINOR_VERSION_PBCFG_C     4
#define WDG_43_INSTANCE0_IPW_AR_RELEASE_REVISION_VERSION_PBCFG_C  0
#define WDG_43_INSTANCE0_IPW_SW_MAJOR_VERSION_PBCFG_C             1
