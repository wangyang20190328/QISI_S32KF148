...
#define LPUART_UART_IP_PBCFG_AR_RELEASE_MINOR_VERSION_C      4
#define LPUART_UART_IP_PBCFG_AR_RELEASE_REVISION_VERSION_C   0
#define LPUART_UART_IP_PBCFG_SW_MAJOR_VERSION_C              1
...
extern Lpuart_Uart_Ip_StateStructureType Lpuart_Uart_Ip_apStateStructure[2U];
...
#endif
    /* Runtime state structure refference */
    &Lpuart_Uart_Ip_apStateStructure[1]
