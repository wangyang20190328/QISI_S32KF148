...
*/
#define AdcHwUnit_ADC0                               (0U)
#define AdcHwUnit_ADC1                               (1U)
...
*/
#define TANK_MCU_2_DETECT_IN                       (0x0U)
#define TANK_MCU_1_DETECT_IN                       (0x1U)
#define VBAT_ALL_MUX                       (0x2U)
#define VBAT_MB_MUX                       (0x3U)
#define HW_PHASE_ID                       (0x1000U)
#define HW_PHASE_VERSION_ID                       (0x1001U)
#define VBAT_CUR_MONITOR                       (0x1002U)
...
#define AdcConf_AdcGroup_ADC0               (0U)
#define AdcConf_AdcGroup_ADC1               (1U)
