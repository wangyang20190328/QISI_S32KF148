...
#define DMA_IP_NOF_CFG_LOGIC_CHANNELS   ((uint32)8U)

/* Logic Channel 0 */
#define DMA_LOGIC_CH_3      ((uint8)0U)


/* Logic Channel 1 */
#define DMA_LOGIC_CH_2      ((uint8)1U)


/* Logic Channel 2 */
#define DMA_LOGIC_CH_5      ((uint8)2U)


/* Logic Channel 3 */
#define DMA_LOGIC_CH_4      ((uint8)3U)


/* Logic Channel 4 */
#define DMA_LOGIC_CH_6      ((uint8)4U)


/* Logic Channel 5 */
#define DMA_LOGIC_CH_7      ((uint8)5U)


/* Logic Channel 6 */
#define DMA_LOGIC_CH_1      ((uint8)6U)


/* Logic Channel 7 */
#define DMA_LOGIC_CH_0      ((uint8)7U)
