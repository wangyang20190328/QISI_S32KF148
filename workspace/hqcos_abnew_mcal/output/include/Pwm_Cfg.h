...
*
*/
#define KBD_PWM_1                            ((Pwm_ChannelType)0U)
#define KBD_PWM_2                            ((Pwm_ChannelType)1U)

/**
* @brief        Symbolic name for configured channels - TPS_ECUC_02108 compliant.
*
*/
#define PwmConf_PwmChannelConfigSet_KBD_PWM_1          ((Pwm_ChannelType)0U)
#define PwmConf_PwmChannelConfigSet_KBD_PWM_2          ((Pwm_ChannelType)1U)
