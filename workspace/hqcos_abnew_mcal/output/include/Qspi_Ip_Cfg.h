...
/* Check if current file and Qspi_Ip_PBcfg header file are of the same vendor */
#if (QSPI_IP_VENDOR_ID_CFG != QSPI_IP_PBCFG_VENDOR_ID)
    #error "Qspi_Ip_Cfg.h and Qspi_Ip_PBcfg.h have different vendor ids"
#endif
/* Check if current file and Qspi_Ip_PBcfg header file are of the same Autosar version */
...
#endif
/* Check if current file and Qspi_Ip_PBcfg header file are of the same software version */
