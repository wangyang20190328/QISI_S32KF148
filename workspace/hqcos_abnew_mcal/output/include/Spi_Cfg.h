...
*/
#define SPI_LEVEL_DELIVERED            (SPI_LEVEL1)
...
*/
#define SpiConf_SpiChannel_SpiChannel_MCU_SBC    ((Spi_ChannelType)0)
#define SpiConf_SpiChannel_SpiChannel_MCU_SOC    ((Spi_ChannelType)1)
...
*     for all the driver configurations.
*/
#define SpiConf_SpiSequence_SpiSequence_MCU_SBC   ((Spi_SequenceType)0)
#define SpiConf_SpiSequence_SpiSequence_MCU_SOC   ((Spi_SequenceType)1)
...
*/
#define SPI_SpiExternalDevice_MCU_SBC  ((Spi_ExternalDeviceType)0u)
#define SPI_SpiExternalDevice_MCU_SOC  ((Spi_ExternalDeviceType)1u)
