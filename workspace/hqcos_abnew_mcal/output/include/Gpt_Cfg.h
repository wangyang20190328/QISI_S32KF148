...
*/
    #define GptConf_GptChannelConfiguration_GptChannelConfiguration_WdgTrig  (0U)
            
    #define GptConf_GptChannelConfiguration_GptChannelConfiguration_0  (1U)
            
    #define GptConf_GptChannelConfiguration_GptChannelConfiguration_WdgTrig_43  (2U)
